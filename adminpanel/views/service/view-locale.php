...
{
	$keys = [
		'delete-one', 'delete-many', 'delete-one-finally', 'delete-many-finally', 'restore-one', 
		...
		'not-uploaded-files', 'upload-file', 'upload-image', 'select-fields', 'select-csv-file', 'quick-edit-limit', 
		'choose-skin', 'search-by-name', 'add-edit-comment', 'move-left', 'move-right', 'move-first', 'move-last', 'delete',
