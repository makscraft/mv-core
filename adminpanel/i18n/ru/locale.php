...
$regionalData = [
	...
	'month_case' => ['Января','Февраля','Марта','Апреля','Мая','Июня','Июля', 
	...
	'translation' => [
		...
		'error-wrong-token' => "Что-то пошло не так... Обновите страницу и попробуйте еще раз.",
		'error-wrong-ajax-token' => "Что-то пошло не так... Обновите страницу и попробуйте еще раз.",
		...
		'error-redirect-format' => "Значение поля '{field}' должно содержать URL адрес в формате 'https://example.com'.",
